                ...
                <Fade duration = {2000} bottom>
                    <div className = {`${styles.container}`}>
                        <div style = {{zIndex: '10', position: 'absolute', top: '186px', left: '103px'}}>
                            {marker == 0 ?
                                <div className = {styles.marker}>
                                    <Image priority src = '/marker_green.png' width = '36' height = '36'/> 
                                </div>
                            :
                                <Image priority src = '/marker_blue.png' width = '36' height = '36'/> 
                            }
                        </div>
                        ...
                        <div className = {styles.mapCon} style = {{position: 'relative'}}>
                            <Image priority src = '/landing_sec7_maps.svg' layout = 'fill'/>
                        </div>
                    </div>
                </Fade>
            </PaddingLayout>
